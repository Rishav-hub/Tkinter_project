...
class Window:
    ...
    def update_command(self):
        database.update(selected_tuple[0self.],title_text.get(),self.author_text.get(),self.year_text.get(),self.ISBN_text.get())

    def __init__(self,window):
        #self.window=window
        self.window.wm_title("MyBookstore")
        ...
        self.e1=Entry(window,textvariable=title_text)
